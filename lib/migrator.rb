...
class Migrator
  ...
  def tickets!
    ...
    tickets.each do |t|
      ...
      assignee = @assignee_map[main.attributes['assigned_user_name']] if main.attributes['assigned_user_name']
      milestone = @milestone_map[main.attributes['milestone_title']] if main.attributes['milestone_title']
      title = ticket.title
      body = main.body
